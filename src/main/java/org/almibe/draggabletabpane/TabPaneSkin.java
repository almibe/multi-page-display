...
public class TabPaneSkin extends BehaviorSkinBase<TabPane, TabPaneBehavior> {
    ...
    private ObjectProperty<TabAnimation> openTabAnimation = new
            StyleableObjectProperty<TabAnimation>(TabAnimation.GROW) {
    ...
    private ObjectProperty<TabAnimation> closeTabAnimation = new
            StyleableObjectProperty<TabAnimation>(TabAnimation.GROW) {
                @Override public CssMetaData<TabPane,TabAnimation> getCssMetaData() {
...
//                System.out.println("HEADER - in drag over");
//            }
//        });
//        tabHeaderArea.setOnDragEntered(new EventHandler<DragEvent>() {
//            @Override
//            public void handle(DragEvent dragEvent) {
//                System.out.println("HEADER - in drag entered");
//            }
//        });
//        tabHeaderArea.setOnDragExited(new EventHandler<DragEvent>() {
//            @Override
//            public void handle(DragEvent dragEvent) {
//                System.out.println("HEADER - in drag exited");
//            }
//        });
//        tabHeaderArea.setOnDragDropped(new EventHandler<DragEvent>() {
//            @Override
//            public void handle(DragEvent dragEvent) {
//                System.out.println("HEADER - in drag dropped");
//            }
//        });
//        tabHeaderArea.setOnMouseDragged(new EventHandler<MouseEvent>() {
//            @Override
//            public void handle(MouseEvent mouseEvent) {
//                System.out.println("header - in mouse dragged");
//
//                //mouseEvent.consume();
//            }
//        });
//        tabHeaderArea.setOnMouseDragEntered(new EventHandler<MouseDragEvent>() {
//            public void handle(MouseDragEvent e) {
//                System.out.println("header - in mouse drag entered");
//                //e.consume();
//            }
//        });
//        tabHeaderArea.setOnMouseDragExited(new EventHandler<MouseDragEvent>() {
//            public void handle(MouseDragEvent e) {
//                System.out.println("header - in mouse drag exited");
//                //e.consume();
//            }
//        });
//        tabHeaderArea.setOnMouseDragReleased(new EventHandler<MouseDragEvent>() {
//            public void handle(MouseDragEvent e) {
//                System.out.println("header - in mouse drag released");
//                //e.consume();
//            }
//        });
//        tabHeaderArea.setOnMouseDragOver(new EventHandler<MouseDragEvent>() {
//            @Override
//            public void handle(MouseDragEvent mouseDragEvent) {
////                System.out.println("header - in mouse drag drag over");
////                mouseDragEvent.consume();
//            }
//        });


       /* End DnD Customization */
        ...
        registerChangeListener(tabPane.getSelectionModel().selectedItemProperty(),
                "SELECTED_TAB");
        ...
        if (selectedTab == null && getSkinnable().getSelectionModel().getSelectedIndex()
                != -1) {
    ...
    private void removeTabs(List<? extends Tab> removedList, final Map<Tab, Timeline>
            closedTab) {
        for (final Tab tab : removedList) {
            ...
            if (tabRegion != null) {
                if( closeTabAnimation.get() == TabAnimation.GROW ) {
                    ...
                    closedTabTimeline = createTimeline(tabRegion,
                            Duration.millis(ANIMATION_SPEED * 1.5F), 0.0F, new EventHandler<ActionEvent>() {
    ...
    private void addTabs(List<? extends Tab> addedList, int from, boolean handle, final
    Map<Tab, Timeline> closedTab) {
        int i = 0;
                ...
                if( openTabAnimation.get() == TabAnimation.GROW ) {
                    tabRegion.animateNewTab = new Runnable() {
                        @Override public void run() {
                            ...
                            createTimeline(tabRegion, Duration.millis(ANIMATION_SPEED), w,
    ...
    private Timeline createTimeline(final TabHeaderSkin tabRegion, final Duration
            duration, final double endValue, final EventHandler<ActionEvent> func) {
        Timeline timeline = new Timeline();
        timeline.setCycleCount(1);

        KeyValue keyValue = new KeyValue(tabRegion.prefWidth, endValue,
                Interpolator.LINEAR);
...
//    }
    ...
    @Override protected double computePrefWidth(double height, double topInset, double
            rightInset, double bottomInset, double leftInset) {
    ...
    @Override protected double computePrefHeight(double width, double topInset, double
            rightInset, double bottomInset, double leftInset) {
    ...
    @Override public double computeBaselineOffset(double topInset, double rightInset,
    ...
    @Override protected void layoutChildren(final double x, final double y,
        ...
        if (tabPosition == Side.TOP) {
            ...
            tabHeaderArea.getTransforms().clear();
            tabHeaderArea.getTransforms().add(new Rotate(getRotation(Side.BOTTOM), 0,
                    headerHeight));
            ...
            tabHeaderArea.getTransforms().clear();
            tabHeaderArea.getTransforms().add(new Rotate(getRotation(Side.LEFT), 0,
                    headerHeight));
        } else if (tabPosition == Side.RIGHT) {
            tabHeaderArea.resize(h, headerHeight);
            tabHeaderArea.relocate(tabsStartX, y - headerHeight);
            tabHeaderArea.getTransforms().clear();
            tabHeaderArea.getTransforms().add(new Rotate(getRotation(Side.RIGHT), 0,
                    headerHeight));
        }
    ...
    private static class StyleableProperties {
        ...
        private final static CssMetaData<TabPane,TabAnimation> OPEN_TAB_ANIMATION =
                new CssMetaData<TabPane,
                        TabPaneSkin.TabAnimation>("-fx-open-tab-animation",
                    ...
                    @Override public StyleableProperty<TabAnimation>
                    getStyleableProperty(TabPane node) {
        ...
        private final static CssMetaData<TabPane,TabAnimation> CLOSE_TAB_ANIMATION =
                new CssMetaData<TabPane,
                        TabPaneSkin.TabAnimation>("-fx-close-tab-animation",
                        new EnumConverter<TabAnimation>(TabAnimation.class),
                        TabAnimation.GROW) {
        ...
        public TabHeaderArea() {
            ...
            headersRegion = new StackPane() {
                ...
                @Override protected void layoutChildren() {
                    if (tabsFit()) {
                        ...
                        if (!removeTab.isEmpty()) {
                            ...
                            double w = tabHeaderArea.getWidth() -
                                    snapSize(controlButtons.prefWidth(-1)) - firstTabIndent() - SPACER;
                    ...
                    if (isSelectingTab) {
                        ...
                        for (Node node: getChildren()) {
                            ...
                            if (previousSelectedTab != null &&
                                    previousSelectedTab.equals(tabHeader.getTab())) {
                        ...
                        if (selectedTabOffset > previousSelectedTabOffset) {
                            scrollToSelectedTab(selectedTabOffset + selectedTabWidth,
                                    previousSelectedTabOffset);
                        } else {
                            scrollToSelectedTab(selectedTabOffset,
                                    previousSelectedTabOffset);
                        }
                        isSelectingTab = false;
                    }
                    ...
                    double tabX = (tabPosition.equals(Side.LEFT) ||
                    ...
                    for (Node node : getChildren()) {
                        ...
                        double startY = tabPosition.equals(Side.BOTTOM) ?
                                0 : tabBackgroundHeight - tabHeaderPrefHeight -
                                snappedBottomInset();
...
//        private ImageView dragGhost = new ImageView();
        ...
        private void addTab(Tab tab, int addToIndex, boolean visible) {
            final TabHeaderSkin tabHeaderSkin = new TabHeaderSkin(tab);
            tabHeaderSkin.setVisible(visible);

            tabHeaderSkin.setOnMouseReleased(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent mouseEvent) {
                 //   tabHeaderSkin.setMouseTransparent(false);
  //                  tabHeaderArea.getChildren().remove(dragGhost);
                    mouseEvent.consume();
                }
            });
            tabHeaderSkin.setOnDragDetected(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent mouseEvent) {

                    //SnapshotParameters snapshotParameters = new SnapshotParameters();
                    //snapshotParameters.setFill(Color.TRANSPARENT);
//                    dragGhost.setImage(tabHeaderSkin.snapshot(snapshotParameters,null));
//                    if(!tabHeaderArea.getChildren().contains(dragGhost)) {
//                        tabHeaderArea.getChildren().add(dragGhost);
//                    }
                    tabHeaderSkin.startFullDrag();

                    //tabHeaderSkin.setMouseTransparent(true);
//                    dragGhost.setMouseTransparent(true);
                    dragDetected = mouseEvent;
                    mouseEvent.consume();
                }
            });
            tabHeaderSkin.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent mouseEvent) {
//                    Point2D localPoint = tabHeaderArea.sceneToLocal(new Point2D(mouseEvent.getSceneX(), mouseEvent.getSceneY()));
//                    dragGhost.relocate(
//                            (int)(localPoint.getX() - dragGhost.getBoundsInLocal().getWidth() / 2),
//                            (int)(localPoint.getY() - dragGhost.getBoundsInLocal().getHeight() / 2)
//                    );
                    mouseEvent.consume();
                }
            });
            tabHeaderSkin.setOnMouseDragEntered(new EventHandler<MouseDragEvent>() {
                public void handle(MouseDragEvent e) {
//                    System.out.println("in mouse drag entered");
//                    e.consume();
                    Tab sourceTab = ((TabHeaderSkin)e.getGestureSource()).getTab();
                    Tab targetTab = ((TabHeaderSkin)e.getTarget()).getTab();
                    if(sourceTab != targetTab) {
                        //Platform.runLater(() -> {
                            TabPaneSkin.this.closeTabAnimation.set(TabAnimation.NONE);
                            TabPaneSkin.this.openTabAnimation.set(TabAnimation.NONE);
                            TabPane tp = TabPaneSkin.this.getSkinnable();

                            int sourceIndex = tp.getTabs().indexOf(sourceTab);
                            int targetIndex = tp.getTabs().indexOf(targetTab);

                            //int index = tp.getTabs().indexOf(targetTab);
                            

                            if(sourceIndex > targetIndex) {
                                    tp.getTabs().remove(sourceTab);
                                    tp.getTabs().add(targetIndex,(sourceTab));
                                    tp.getSelectionModel().select(sourceTab);
                                    MouseDragEvent.fireEvent(sourceTab,dragDetected); //TODO is there a better way to handle this?
                            } else {
                                //The below code doesn't work for some reason if the tabpane is smaller than all the tabs in the tabpane
//                                    tp.getTabs().remove(sourceTab);
//                                    tp.getTabs().add(targetIndex,(sourceTab));
//                                    tp.getSelectionModel().select(sourceTab);
//                                    MouseDragEvent.fireEvent(sourceTab,dragDetected); //TODO is there a better way to handle this?
                                for(int i = sourceIndex+1; i-1 < targetIndex; i++) {
                                    Tab removedTab = tp.getTabs().remove(i);
                                        tp.getTabs().add(i-1,(removedTab));
                                }
                                tp.getSelectionModel().select(sourceTab);
                                MouseDragEvent.fireEvent(sourceTab,dragDetected); //TODO is there a better way to handle this?
                            }
    ...
    //                        dragGhost.setMouseTransparent(true);
                            ...
                            //tabHeaderArea.getChildren().remove(dragGhost);
                            e.consume();
                            TabPaneSkin.this.closeTabAnimation.set(TabAnimation.GROW);
                            TabPaneSkin.this.openTabAnimation.set(TabAnimation.GROW);
                        //});
                    }
                }
            });
//            tabHeaderSkin.setOnMouseDragExited(new EventHandler<MouseDragEvent>() {
//                public void handle(MouseDragEvent e) {
//                    System.out.println("in mouse drag exited");
//                    e.consume();
//                }
//            });
            tabHeaderSkin.setOnMouseDragReleased(new EventHandler<MouseDragEvent>() {
                public void handle(MouseDragEvent e) {
//                    System.out.println("in mouse drag released");
//                    tabHeaderSkin.setMouseTransparent(false);
//                    tabHeaderArea.getChildren().remove(dragGhost);
                    e.consume();
                }
            });
//            tabHeaderSkin.setOnMouseDragOver(new EventHandler<MouseDragEvent>() {
//                @Override
//                public void handle(MouseDragEvent mouseDragEvent) {
//                    System.out.println("in mouse drag drag over");
//                    mouseDragEvent.consume();
//                }
//            });
           /* End DnD Customization */
        ...
        private void createScrollTimeline(final double val) {
            ...
            scroller.getKeyFrames().add(new KeyFrame(Duration.millis(150), new
        ...
        private void scroll(double d) {
            ...
            double delta = tabPosition.equals(Side.LEFT) ||
                    tabPosition.equals(Side.BOTTOM) ? -d : d;
        ...
        private boolean tabsFit() {
            double headerPrefWidth = snapSize(headersRegion.prefWidth(-1));
            double controlTabWidth = snapSize(controlButtons.prefWidth(-1));
            double visibleWidth = headerPrefWidth + controlTabWidth + firstTabIndent() +
                    SPACER;
        ...
        private void scrollToSelectedTab(double selected, double previous) {
            if (selected > previous) {
                ...
                double width = snapSize(getWidth()) -
                        snapSize(controlButtons.prefWidth(-1)) - firstTabIndent() - SPACER;
                if (offset > width) {
        ...
        @Override protected void layoutChildren() {
            ...
            if (tabPosition.equals(Side.TOP)) {
                ...
                controlStartY = snapSize(getHeight()) -
                        controlButtons.getControlTabHeight() - bottomInset;
                ...
                controlStartY = snapSize(getHeight()) -
                        controlButtons.getControlTabHeight() - leftInset;
                ...
                controlStartY = snapSize(getHeight()) -
                        controlButtons.getControlTabHeight() - topInset;
                ...
                controlStartY = snapSize(getHeight()) -
                        controlButtons.getControlTabHeight() - rightInset;
            }
            if (headerBackground.isVisible()) {
                positionInArea(headerBackground, 0, 0,
                        snapSize(getWidth()), snapSize(getHeight()), /*baseline
ignored*/0, HPos.CENTER, VPos.CENTER);
            }
            positionInArea(headersRegion, startX, startY, w, h, /*baseline ignored*/0,
                    HPos.LEFT, VPos.CENTER);
            positionInArea(controlButtons, controlStartX, controlStartY, btnWidth,
                    controlButtons.getControlTabHeight(),
    ...
    class TabHeaderSkin extends StackPane {
        ...
        private final ListChangeListener<String> styleClassListener = new
        ...
        public TabHeaderSkin(final Tab tab) {
            ...
            inner = new StackPane() {
                @Override protected void layoutChildren() {
                    ...
                    final double closeBtnWidth = showCloseButton() ?
                            snapSize(closeBtn.prefWidth(-1)) : 0;
                    final double closeBtnHeight = showCloseButton() ?
                            snapSize(closeBtn.prefHeight(-1)) : 0;
                    ...
                    // provided max width.
                    double closeBtnStartX = (maxWidth < Double.MAX_VALUE ? Math.min(w,
                            maxWidth) : w) - paddingRight - closeBtnWidth;
                    ...
                    if (closeBtn.isVisible()) {
                        ...
                        positionInArea(closeBtn, closeBtnStartX, paddingTop,
                                closeBtnWidth, h,
                               /*baseline ignored*/0, HPos.CENTER, VPos.CENTER);
                    }
            ...
            setOnContextMenuRequested(new EventHandler<ContextMenuEvent>() {
                @Override public void handle(ContextMenuEvent me) {
                    if (getTab().getContextMenu() != null) {
                        getTab().getContextMenu().show(inner, me.getScreenX(),
                                me.getScreenY());
                        me.consume();
                    }
                }
            ...
            if (label.getGraphic() != null) {
                label.getGraphic().setRotate(getSkinnable().isRotateGraphic() ? 0.0F :
                        (getSkinnable().getSide().equals(Side.RIGHT) ? -90.0F :
                                (getSkinnable().getSide().equals(Side.LEFT) ? 90.0F :
                                        0.0F)));
            }
        }
        ...
        private boolean showCloseButton() {
            return tab.isClosable() &&
                    ...
                    (getSkinnable().getTabClosingPolicy().equals(TabClosingPolicy.ALL_TABS) ||
                            ...
                            getSkinnable().getTabClosingPolicy().equals(TabClosingPolicy.SELECTED_TAB) &&
                                    tab.isSelected());
        }
    ...
    class TabContentRegion extends StackPane implements TraverseListener {
        ...
        @Override public void onTraverse(Node node, Bounds bounds) {
            ...
            if (index == -1 && direction.equals(Direction.NEXT)) {
                ...
                new TraversalEngine(getSkinnable(), false).trav(getSkinnable(),
                        Direction.NEXT);
            }
        }
    ...
    class TabControlButtons extends StackPane {
        ...
        public TabControlButtons() {
            ...
            inner = new StackPane() {
                private double getArrowBtnWidth() {
                    ...
                    if (isShowTabsMenu()) {
                        maxArrowWidth = Math.max(maxArrowWidth,
                ...
                private double positionTabsMenu(double x, double y, double h, boolean
                        showSep) {
                    double newX = x;
                    if (isShowTabsMenu()) {
                        // DOWN ARROW BUTTON
                ...
                private void positionArrow(Pane btn, StackPane arrow, double x, double y,
        ...
        private final DoubleProperty controlTabHeight = new SimpleDoubleProperty(this,
                "controlTabHeight");
        {
...
//        }
        ...
        @Override protected void layoutChildren() {
            ...
            inner.resize(w, h);
            positionInArea(inner, x, y, w, h, /*baseline ignored*/0, HPos.CENTER,
                    VPos.BOTTOM);
        }
        ...
        private void showControlButtons() {
            ...
            Timeline timeline = new Timeline();
            KeyValue keyValue = new KeyValue(controlTabHeight, prefHeight,
                    Interpolator.EASE_OUT);

            setVisible(true);
            timeline.getKeyFrames().clear();
            timeline.getKeyFrames().add(new KeyFrame(Duration.millis(ANIMATION_SPEED), new
                    EventHandler<ActionEvent>() {
                        @Override public void handle(ActionEvent event) {
                            if (popup == null) {
                                setupPopupMenu();
