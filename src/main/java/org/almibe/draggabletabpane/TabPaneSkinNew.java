...
public class TabPaneSkinNew extends BehaviorSkinBase<TabPane, TabPaneBehavior> {
    ...
    public TabPaneSkinNew(TabPane tabPane) {
   ...
   private static class StyleableProperties {
        ...
        private final static CssMetaData<TabPane,TabAnimation> OPEN_TAB_ANIMATION = 
                new CssMetaData<TabPane, TabPaneSkinNew.TabAnimation>("-fx-open-tab-animation", 
            ...
            @Override public StyleableProperty<TabAnimation> getStyleableProperty(TabPane node) {
                TabPaneSkinNew skin = (TabPaneSkinNew) node.getSkin();
        ...
        private final static CssMetaData<TabPane,TabAnimation> CLOSE_TAB_ANIMATION = 
                new CssMetaData<TabPane, TabPaneSkinNew.TabAnimation>("-fx-close-tab-animation", 
                    new EnumConverter<TabAnimation>(TabAnimation.class), TabAnimation.GROW) {
...
//                    System.out.println("mouse released");
  ...
  //                  tabHeaderArea.getChildren().remove(dragGhost);
            ...
            tabHeaderSkin.setOnDragDetected(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent mouseEvent) {
//                    System.out.println("in drag detected");
...
//                    e.consume();
                    Tab sourceTab = ((TabPaneSkinNew.TabHeaderSkin)e.getGestureSource()).getTab();
                    Tab targetTab = ((TabPaneSkinNew.TabHeaderSkin)e.getTarget()).getTab();
                    if(sourceTab != targetTab) {
                        //Platform.runLater(() -> {
                            TabPaneSkinNew.this.closeTabAnimation.set(TabPaneSkinNew.TabAnimation.NONE);
                            TabPaneSkinNew.this.openTabAnimation.set(TabPaneSkinNew.TabAnimation.NONE);
                            TabPane tp = TabPaneSkinNew.this.getSkinnable();
...
//        }
    ...
    class TabMenuItem extends RadioMenuItem {
        ...
        public TabMenuItem(final Tab tab) {
            super(tab.getText(), TabPaneSkinNew.clone(tab.getGraphic()));                        
            this.tab = tab;
            setDisable(tab.isDisable());
