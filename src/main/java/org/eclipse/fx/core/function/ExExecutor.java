...
public final class ExExecutor {
    ...
    private static RuntimeException wrap(Throwable e, String message) {
     ...
     *            the message to use
     */
    public static void executeRunnable(ExRunnable r, String message) {
     ...
     */
    public static void executeRunnable(ExRunnable r, Function<Throwable, RuntimeException> exceptionConverter) {
        try {
            r.wrappedRun();
        } catch (Throwable e) {
     ...
     * @since 2.2.0
     */
    public static void executeRunnable(ExRunnable r, Logger logger) {
        try {
            r.wrappedRun();
        } catch (Throwable t) {
            Logger l = logger;
